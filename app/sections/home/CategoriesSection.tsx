...
const categoryList: CategoriesInfo[] = [
  ...
  { name: "Hogar", img: "/icons/home-bg.png", color: "#628ECB" },
  { name: "Cuidado Personal", img: "/icons/health-bg.png", color: "#8AAEE0" },
  { name: "Accesorios & otros", img: "/icons/misc-bg.png", color: "#B1C9EF" },
];

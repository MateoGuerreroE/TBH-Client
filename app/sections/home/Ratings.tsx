import ReviewScroll from "@/app/staticLayouts/ReviewScroll";
import WrappedMainReview from "@/app/staticLayouts/wrapped/WrappedMainReview";
import { ReviewProps } from "@/components/Review";

const testingInfo: ReviewProps[] = [
  { authorName: "Andrea" },
  { authorName: "Marco" },
  { authorName: "Gerald" },
  { authorName: "Michael" },
